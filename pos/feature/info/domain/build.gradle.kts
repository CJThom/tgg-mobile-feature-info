...
android {
    ...
    namespace = AppBuildConfig.Modules.Internal.Info.Domain.directory
...
publishing {
    publications {
        ...
        val baseArtifactId = "tgg-mobile-feature-info-domain"
//
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.OFFLINE.name}Debug"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.OFFLINE.name}Debug"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.OFFLINE.name}Release"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.OFFLINE.name}Release"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.DEV.name}Debug"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.DEV.name}Debug"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.DEV.name}Release"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.DEV.name}Release"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.TST.name}Debug"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.TST.name}Debug"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.TST.name}Release"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.TST.name}Release"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.UAT.name}Debug"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.UAT.name}Debug"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.UAT.name}Release"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.UAT.name}Release"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.PRD.name}Debug"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.PRD.name}Debug"])
...
//
//            groupId = TGGBuildConfig.publishingGroupId
//            artifactId = "$baseArtifactId.${TGGBuildConfig.Flavors.PRD.name}Release"
//            version = AppBuildConfig.Config.versionName
//
//            afterEvaluate {
//                from(components["${TGGBuildConfig.Flavors.PRD.name}Release"])
